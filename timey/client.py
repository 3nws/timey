from typing import Any, Generator, Coroutine, Optional, List
...
class Timey:
    ...
    async def get_current_by_name(self, time_zone: str) -> Response:
        return await self.http._get_current_time_by_name(time_zone)

    async def get_current_by_geo(self, latitude: float, longitude: float) -> Response:
        return await self.http._get_current_time_by_geo(latitude, longitude)

    async def get_current_by_ip(self, ip: str) -> Response:
    ...
    async def get_timezone_by_name(self, time_zone: str) -> Response:
        return await self.http._get_timezone_by_name(time_zone)

    async def get_timezone_by_geo(self, latitude: float, longitude: float) -> Response:
        return await self.http._get_timezone_by_geo(latitude, longitude)

    async def get_timezone_by_ip(self, ip: str) -> Response:
    ...
    async def get_user_friendly(self, time: str, lang: str) -> Response:
    ...
    async def day_of_the_week(self, date: str) -> Response:
    ...
    async def add_time(self, time_zone: str, time_span: str) -> Response:
    ...
    async def subtract_time(self, time_zone: str, time_span: str) -> Response:
